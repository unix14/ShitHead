...
namespace GoFish
{
    ...
    public class ProtectedData
    {
        ...
        public int currentGameState { get; private set; }
        ...
        public void RemoveCardFromPlayer(Player player, byte cardValueToRemove)
        {
            Decrypt();
        ...
        void Decrypt()
        {
            ...
            byte booksForPlayer2ount = message.PopByte();
            booksForPlayer2 = message.PopByteArray(booksForPlayer2ount).ToList();
